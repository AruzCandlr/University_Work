...
public abstract class Object3D implements volGetter{
	...
	{
		//****************** YOUR CODE HERE *************************//
		if(DENSITIES[this.matType.ordinal()] < DENSITIES[Material.Water.ordinal()]) {
			return true;
		}
		return false;
		//***********************************************************//
	...
	{
		//****************** YOUR CODE HERE *************************//
		if(DENSITIES[this.matType.ordinal()] < DENSITIES[Material.Air.ordinal()]) {
			return true;
		}
		return false;
		//***********************************************************//
